...
<div id="esc-add-seed-form-container" class="esc-container">
	...
	<form id="esc-add-seed-form" class="esc-form" method="post">
        ...
        <?php // Basic Info & AI Trigger ?>
        <fieldset class="esc-field-group">
            <legend><?php esc_html_e('Seed Identification & AI Search', 'erins-seed-catalog'); ?></legend>

            <div>
                <label for="esc_seed_name"><?php esc_html_e( 'Seed Name', 'erins-seed-catalog' ); ?> <span style="color:red;">*</span></label>
            ...
            <div id="esc-ai-fetch-container">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <p class="description"><?php esc_html_e('Optional: Product code for precise AI search.', 'erins-seed-catalog'); ?></p>
                 </div>

                 <div> <?php // Container for button ?>
                    <button type="button" id="esc-ai-fetch-trigger" class="esc-button esc-button-secondary">
                        <span class="dashicons dashicons-search" style="vertical-align: middle; margin-top: -2px;"></span> <?php esc_html_e( 'Fetch AI Info', 'erins-seed-catalog' ); ?>
                    </button>
                 </div>
            </div>
            <div id="esc-ai-status"></div>

            <?php // AI Result Display Area (hidden by default) ?>
            <div id="esc-ai-result-display" style="display: none;">
                <?php // Content populated by JavaScript ?>
            </div>
        </fieldset>
        ...
        <button type="submit" class="esc-button"><?php esc_html_e( 'Add Seed to Catalog', 'erins-seed-catalog' ); ?></button>
