...
<div id="esc-search-container">
    <form id="esc-search-form" class="esc-form" method="get" action="<?php /* echo esc_url(home_url('/')); */ // Action URL not strictly needed for AJAX ?>">
        ...
        <?php // Add reset button? ?>
        <?php /* <button type="reset" class="esc-button esc-button-secondary"><?php esc_html_e( 'Reset', 'erins-seed-catalog' ); ?></button> */ ?>
    </form>
</div>