...
class ESC_Gemini_API {
    ...
    private static function build_api_prompt( string $seed_name, ?string $variety = null, ?string $brand = null, ?string $sku_upc = null ) : string {
        ...
        $prompt .= "  \"image_url\": \"string|null - Suggest one high-quality image URL (HTTPS required) of the mature plant, fruit/flower, or seeds, suitable for display. CRITICAL GUIDELINES FOR IMAGE URLS:\n1. ONLY provide URLs that you are CERTAIN exist and are publicly accessible\n2. PREFERRED SOURCES: Use images from Pixabay, Unsplash, Pexels, or Flickr Creative Commons - these are more reliable than Wikimedia Commons\n3. For Pixabay, use format: https://pixabay.com/photos/[image-name]-[image-id]/\n4. For Unsplash, use format: https://unsplash.com/photos/[image-id]\n5. For Pexels, use format: https://www.pexels.com/photo/[image-name]-[image-id]/\n6. For Flickr, use format: https://live.staticflickr.com/[server]/[id]_[secret]_b.jpg\n7. AVOID Wikimedia Commons unless you are 100% certain the file exists\n8. AVOID commercial seed catalogs (Burpee, Baker Creek, Johnny's Seeds, Stark Bros)\n9. VERIFY that the URL ends with an image extension (.jpg, .jpeg, .png, .gif)\n10. If you cannot find a reliable image URL, return null instead of providing a potentially broken link\",\n";
