...
class ESC_Gemini_API {
    ...
    private static function build_api_prompt( string $seed_name, ?string $variety = null, ?string $brand = null, ?string $sku_upc = null ) : string {
        ...
        $prompt .= "  \"image_url\": \"string|null - IMPORTANT: Find a high-quality image URL (HTTPS required) that SPECIFICALLY shows the PLANT, FRUIT, FLOWER, or SEEDS of this exact variety. DO NOT return images of buildings, landscapes, or unrelated subjects. CRITICAL GUIDELINES FOR IMAGE URLS:\n1. The image MUST show the actual plant, fruit, flower, or seeds of this specific variety\n2. ONLY provide DIRECT image URLs that end with .jpg, .jpeg, .png, or .gif - NOT links to pages\n3. PREFERRED DIRECT IMAGE SOURCES:\n   - Pexels: Use format https://images.pexels.com/photos/[id]/pexels-photo-[id].jpeg\n   - Unsplash: Use format https://images.unsplash.com/photo-[id]?auto=format&fit=crop&w=1200\n4. DO NOT use links to Pixabay, Unsplash, or Pexels pages - ONLY direct image links\n5. AVOID Wikimedia Commons and Flickr as they often have broken links\n6. AVOID commercial seed catalogs (Burpee, Baker Creek, Johnny's Seeds, Stark Bros)\n7. VERIFY the URL by checking that it ends with an image extension (.jpg, .jpeg, .png, .gif)\n8. If you cannot find a reliable DIRECT image URL of the actual plant, return null instead\n9. EXAMPLE of good URL: https://images.pexels.com/photos/4750270/pexels-photo-4750270.jpeg\",\n";
        $prompt .= "  \"image_source_url\": \"string|null - The source page URL where the image can be found. This is important for manual download if automatic download fails. Example: https://www.pexels.com/photo/close-up-photo-of-strawberries-4750270/\",\n";
