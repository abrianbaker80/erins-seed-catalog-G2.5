...
class ESC_Gemini_API {
    ...
    private static function build_api_prompt( string $seed_name, ?string $variety = null, ?string $brand = null, ?string $sku_upc = null ) : string {
        ...
        $prompt .= "  \"image_source_url\": \"string|null - IMPORTANT: Search the internet for a high-quality, royalty-free image depicting this specific plant variety. CRITICAL REQUIREMENTS:\n\n1. SUBJECT: The image MUST clearly show the PLANT, FRUIT, FLOWER, or SEEDS of this exact variety. For fruits like blueberries, strawberries, etc., prioritize images showing the ripe fruit on the plant. DO NOT return URLs to buildings, landscapes, or unrelated subjects.\n\n2. LICENSING: The image must be explicitly licensed as royalty-free, Creative Commons Zero (CC0), public domain, or under another permissive license that allows for free download and use without requiring payment or complex attribution.\n\n3. SOURCE: Prioritize these reputable free stock photo websites that clearly state the license terms:\n   - Pixabay: Use format https://pixabay.com/photos/[description]-[id]/ (MOST RELIABLE)\n   - Unsplash: Use format https://unsplash.com/photos/[id]\n   - Wikimedia Commons: Use format https://commons.wikimedia.org/wiki/File:[filename]\n   - Public domain botanical sites with stable URLs\n\n4. DOWNLOADABILITY: The URL MUST lead to a page where the image can be easily downloaded. VERIFY THE URL IS VALID AND ACCESSIBLE before returning it.\n\n5. SEARCH STRATEGY: Search specifically for the exact variety name + 'fruit' or 'plant' or 'flower' to find the most relevant images.\n\n6. AVOID:\n   - Commercial seed catalogs (Burpee, Baker Creek, Johnny's Seeds, Stark Bros) as they often restrict image downloads\n   - Any site that requires login or has download restrictions\n   - Any URL that you cannot verify is working\n\n7. If you cannot find a reliable source with good plant images, return null\n\n8. EXAMPLE of good URL: https://pixabay.com/photos/strawberry-red-fruit-sweet-food-2960533/\",\n";
