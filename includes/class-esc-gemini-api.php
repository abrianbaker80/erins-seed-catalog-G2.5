...
class ESC_Gemini_API {
    ...
    private static function build_api_prompt( string $seed_name, ?string $variety = null, ?string $brand = null, ?string $sku_upc = null ) : string {
        ...
        $prompt .= "  \"image_source_url\": \"string|null - IMPORTANT: Find a high-quality webpage URL where the user can find and download an image that SPECIFICALLY shows the PLANT, FRUIT, FLOWER, or SEEDS of this exact variety. DO NOT return URLs to buildings, landscapes, or unrelated subjects. CRITICAL GUIDELINES:\n1. The page MUST contain CLOSE-UP, DETAILED images of the actual plant, fruit, flower, or seeds of this specific variety\n2. PREFERRED IMAGE SOURCES:\n   - Pexels: Use format https://www.pexels.com/photo/[description]-[id]/\n   - Unsplash: Use format https://unsplash.com/photos/[id]\n   - Pixabay: Use format https://pixabay.com/photos/[description]-[id]/\n   - Wikimedia Commons: Use format https://commons.wikimedia.org/wiki/File:[filename]\n   - Public domain botanical sites\n3. AVOID commercial seed catalogs (Burpee, Baker Creek, Johnny's Seeds, Stark Bros) as they often restrict image downloads\n4. VERIFY the URL leads to a page with clear, high-quality images of the plant\n5. SEARCH SPECIFICALLY for the exact variety name + 'fruit' or 'plant' or 'flower' to find the most relevant images\n6. For fruits like blueberries, strawberries, etc., prioritize images showing the ripe fruit on the plant\n7. If you cannot find a reliable source with good plant images, return null\n8. EXAMPLE of good URL: https://www.pexels.com/photo/close-up-photo-of-strawberries-4750270/\",\n";
