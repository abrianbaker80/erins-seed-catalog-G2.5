...
class ESC_Gemini_API {
    ...
    private static function build_api_prompt( string $seed_name, ?string $variety = null, ?string $brand = null, ?string $sku_upc = null ) : string {
        ...
        $prompt .= "  \"image_url\": \"string|null - Suggest one high-quality image URL (HTTPS required) of the mature plant, fruit/flower, or seeds, suitable for display. CRITICAL GUIDELINES FOR IMAGE URLS:\n1. ONLY provide DIRECT image URLs that end with .jpg, .jpeg, .png, or .gif - NOT links to pages\n2. PREFERRED DIRECT IMAGE SOURCES:\n   - Pexels: Use format https://images.pexels.com/photos/[id]/pexels-photo-[id].jpeg\n   - Unsplash: Use format https://images.unsplash.com/photo-[id]?auto=format&fit=crop&w=1200\n3. DO NOT use links to Pixabay, Unsplash, or Pexels pages - ONLY direct image links\n4. AVOID Wikimedia Commons and Flickr as they often have broken links\n5. AVOID commercial seed catalogs (Burpee, Baker Creek, Johnny's Seeds, Stark Bros)\n6. VERIFY the URL by checking that it ends with an image extension (.jpg, .jpeg, .png, .gif)\n7. TEST the URL to ensure it's accessible before providing it\n8. If you cannot find a reliable DIRECT image URL, return null instead\n9. EXAMPLE of good URL: https://images.pexels.com/photos/4750270/pexels-photo-4750270.jpeg\",\n";
